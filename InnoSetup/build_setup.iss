...
#define MyAppURL "https://github.com/QQxiaoming/QFSViewer"
#define MyAppExeName "QFSViewer.exe"
...
[Files]
Source: "..\InnoSetup\build\QFSviewer.exe"; DestDir: "{app}"; Flags: ignoreversion
